...
compress <- function(r_content, format) {
    .Call('_memCompression_compress', PACKAGE = 'memCompression', r_content, format)
}
...
#' compressed <- compress(raw, format = "gzip")
#' decompressed <- decompress(compressed, format = "gzip", 1000)
decompress <- function(r_source, format, r_guess_size) {
    .Call('_memCompression_decompress', PACKAGE = 'memCompression', r_source, format, r_guess_size)
}
